// Upstream regression vectors and assertions; see THIRD_PARTY_NOTICES.md.
import Foundation
import Testing
...
func typedStreamRejectsTruncatedAndInvalidLengthFrames() {
  ...
  for payload: [UInt8] in [
    ...
    #expect(TypedStreamParser.parseAttributedBody(Data(header + payload)) == nil)
  }
}
...
func typedStreamParserDecodesUTF16LittleEndianBOM() throws {
  ...
  #expect(TypedStreamParser.parseAttributedBody(Data([0xff, 0xfe, 0x61])) == nil)
}
